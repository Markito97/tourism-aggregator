...
export interface AdminFormValues extends FieldValues {
  houseName: string;
  address: string;
  lake: string;
  price: string;
...
export const AdminForm = () => {
  ...
  const { control, handleSubmit, setValue } = useForm<AdminFormValues>({
    defaultValues: {
      houseName: '',
      address: '',
      lake: '',
  ...
  const onSubmit = (house: AdminFormValues): void => {
