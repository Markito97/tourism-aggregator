    ...
    return (
        <div className={css.ratingField}>
             ...
             <div className={css.raitingBar}>
                ...
                <div style={{width: `${ratingWidth}`, backgroundColor: 'black'}} onMouseOver = {(e) => e.target.style.backgroundColor = raitingColor} onMouseLeave = {(e) => e.target.style.backgroundColor = 'black'}></div>
